    ...
    <main className="wrap">
      ...
      <div className="cv-section">
        ...
        <Entry
          ...
          bullets={[
            ...
            "Designed and built WagsWorks OS — the internal platform the team runs daily: deal pipeline, AI contract scanning, paperwork tracking, invoicing and payments through QuickBooks, guestlists, revenue reporting, and team chat.",
          ]}
        />
        <Entry
      ...
      <div className="cv-section">
        ...
        <Entry
          ...
          when="2025 — present"
          bullets={[
            "Frameworkless PWA on Cloudflare Workers + Supabase: deals, contract scanning with Claude, paperwork auto-escalation, QuickBooks Online invoicing and daily payment sync, guestlists, revenue YoY, realtime chat, Gmail integration.",
          ]}
        />
      </div>
